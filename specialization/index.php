...
?><div class="page-header page-header--specialization">
 ...
 <input type="text" name="user_name" placeholder="Введите имя" data-label="Имя пользователя"> <input type="tel" name="user_tel" data-label="Телефон" placeholder="Введите телефон*" data-req="true"> <input type="hidden" value="Новая заявка" name="form_subject"> <label class="style-checkbox"> <input type="checkbox" name="user_agree" value="yes" data-label="Пользователь согласился с условиями" data-req="true" checked=""> <span>Я согласен с <a href="/upload/policy.docx" target="_blank" rel="nofollow">условиями обработки персональных данных</a></span> </label> <button type="submit" class="btn">Оставить заявку</button>
			</form>
		</div>
	</div>
</div>
...
<div class="container">
 ...
 </section> <section class="s-solutions">
<div class="container">
	<div class="h1 title-lines">
		 <?$APPLICATION->IncludeComponent(
	"bitrix:main.include",
 ...
 </section> <section class="s-cases-intros">
<div class="container">
 ...
 </section> <section class="s-analitic-intros"> <img alt="logo" src="/local/templates/noskov/img/logo-sym-white.svg" class="s-analitic-intros__bg">
<div class="container">
