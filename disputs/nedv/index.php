...
$APPLICATION->SetTitle("Споры в сфере недвижимости");
?>


<header class="page-header page-header--disput-realty">
	<div class="container">
		<div class="page-header__title">
			<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
				"AREA_FILE_SHOW" => "file",
				"PATH" => "/includes/nedv/title.php"
			));?>
		</div>
		<div class="page-header__descr">
			<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
				"AREA_FILE_SHOW" => "file",
				"PATH" => "/includes/nedv/head_text.php"
			));?>
		</div>
	...
	<div class="container">
		<div class="row-bg">
			...
			<div class="grid-6 grid-7_l grid-12_m">
				<div class="user-content">
					<div class="h1">
						<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
							"AREA_FILE_SHOW" => "file",
							"PATH" => "/includes/nedv/help_title.php"
						));?>
					</div>
				</div>
				<div class="about-icon-list">
					<div class="about-icon-list__item">
						...
						<div class="user-content">
							<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
								"AREA_FILE_SHOW" => "file",
								"PATH" => "/includes/nedv/help_1.php"
							));?>
						</div>
					</div>
					<div class="about-icon-list__item">
						<div class="about-icon-list__item-img">
							<img src="<?=SITE_TEMPLATE_PATH?>/img/svg/icons/icon-keys.svg" alt="">
						</div>
						<div class="user-content">
							<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
								"AREA_FILE_SHOW" => "file",
								"PATH" => "/includes/nedv/help_2.php"
							));?>
						</div>
					</div>
					<div class="about-icon-list__item">
						<div class="about-icon-list__item-img">
							<img src="<?=SITE_TEMPLATE_PATH?>/img/svg/icons/icon-3-men.svg" alt="">
						</div>
						<div class="user-content">
							<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
								"AREA_FILE_SHOW" => "file",
								"PATH" => "/includes/nedv/help_3.php"
							));?>
						</div>
					</div>
					<div class="about-icon-list__item">
						<div class="about-icon-list__item-img">
							<img src="<?=SITE_TEMPLATE_PATH?>/img/svg/icons/icon-man-chair.svg" alt="">
						</div>
						<div class="user-content">
							<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
								"AREA_FILE_SHOW" => "file",
								"PATH" => "/includes/nedv/help_4.php"
							));?>
						</div>
					</div>
					<div class="about-icon-list__item">
						<div class="about-icon-list__item-img">
							<img src="<?=SITE_TEMPLATE_PATH?>/img/svg/icons/icon-wineglass.svg" alt="">
						</div>
						<div class="user-content">
							<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
								"AREA_FILE_SHOW" => "file",
								"PATH" => "/includes/nedv/help_5.php"
							));?>
						</div>
					</div>
				</div>
			...
			<div class="grid-6 grid-5_l grid-12_m user-content">
				<img src="<?=SITE_TEMPLATE_PATH?>/img/disput-realty-about.jpg" alt="Носков Игорь юрьевич">
			</div>
			...
			<div class="row">
				<div class="grid-12">
					<div class="user-content">
						<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
							"AREA_FILE_SHOW" => "file",
							"PATH" => "/includes/nedv/disput_text.php"
						));?>
					</div>
				</div>
			</div>
			...
			<div class="grid-6 grid-7_l grid-12_m disput-order__info">
				<div class="user-content">
					<div class="h1">
						<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
							"AREA_FILE_SHOW" => "file",
							"PATH" => "/includes/nedv/por_title.php"
						));?>
					</div>
					<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
						"AREA_FILE_SHOW" => "file",
						"PATH" => "/includes/nedv/por_text.php"
					));?>
				</div>
				...
				<div class="details__docs">
					...
					<div class="doc">
						...
						<span>Договор аренды/купли-продажи недвижимости</span>
					</div>
					<div class="doc">
						<img src="<?=SITE_TEMPLATE_PATH?>/img/doc.svg" alt="doc" class="doc__icon">
						<span>Документы, подтверждающие право собственности</span>
					</div>
					<div class="doc">
						<img src="<?=SITE_TEMPLATE_PATH?>/img/doc.svg" alt="doc" class="doc__icon">
					...
					<div class="doc">
						<img src="<?=SITE_TEMPLATE_PATH?>/img/doc.svg" alt="doc" class="doc__icon">
						<span>Переписка между сторонами спора</span>
					</div>
					<div class="doc">
						<img src="<?=SITE_TEMPLATE_PATH?>/img/doc.svg" alt="doc" class="doc__icon">
