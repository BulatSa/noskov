...
<div class="container">
 ...
 </section> <section class="s-disput-order">
<div class="container">
 ...
 <img alt="doc" src="/local/templates/noskov/img/doc.svg" class="doc__icon"> <br>
				...
				<div class="doc">
 <img alt="doc" src="/local/templates/noskov/img/doc.svg" class="doc__icon">&nbsp; &nbsp; &nbsp; &nbsp;Переписка сторон договора
				</div>
				<div class="doc">
 <img alt="doc" src="/local/templates/noskov/img/doc.svg" class="doc__icon">&nbsp; &nbsp; &nbsp; &nbsp;Документы, подтверждающие претензии
				</div>
				<div class="doc">
 <img alt="doc" src="/local/templates/noskov/img/doc.svg" class="doc__icon"> <br>
					 Иная документация
