...
$APPLICATION->SetTitle("Споры в сфере подряда");
?>


<header class="page-header page-header--disput-contract">
	<div class="container">
		<div class="page-header__title">
			<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
				"AREA_FILE_SHOW" => "file",
				"PATH" => "/includes/podr/title.php"
			));?>
		</div>
		<div class="page-header__descr">
			<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
				"AREA_FILE_SHOW" => "file",
				"PATH" => "/includes/podr/head_text.php"
			));?>
		</div>
	...
	<div class="container">
		<div class="row-bg">
			...
			<div class="grid-6 grid-7_l grid-12_m">
				<div class="user-content">
					<div class="h1">
						<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
							"AREA_FILE_SHOW" => "file",
							"PATH" => "/includes/podr/help_title.php"
						));?>
					</div>
				</div>
				<div class="about-icon-list">
					<div class="about-icon-list__item">
						...
						<div class="user-content">
							<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
								"AREA_FILE_SHOW" => "file",
								"PATH" => "/includes/podr/help_1.php"
							));?>
						</div>
					</div>
					<div class="about-icon-list__item">
						<div class="about-icon-list__item-img">
							<img src="<?=SITE_TEMPLATE_PATH?>/img/svg/icons/icon-microscope.svg" alt="">
						</div>
						<div class="user-content">
							<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
								"AREA_FILE_SHOW" => "file",
								"PATH" => "/includes/podr/help_2.php"
							));?>
						</div>
					</div>
					<div class="about-icon-list__item">
						<div class="about-icon-list__item-img">
							<img src="<?=SITE_TEMPLATE_PATH?>/img/svg/icons/icon-doc-act.svg" alt="">
						</div>
						<div class="user-content">
							<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
								"AREA_FILE_SHOW" => "file",
								"PATH" => "/includes/podr/help_3.php"
							));?>
						</div>
					</div>
					<div class="about-icon-list__item">
						...
						<div class="user-content">
							<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
								"AREA_FILE_SHOW" => "file",
								"PATH" => "/includes/podr/help_4.php"
							));?>
						</div>
					</div>
					<div class="about-icon-list__item">
						<div class="about-icon-list__item-img">
							<img src="<?=SITE_TEMPLATE_PATH?>/img/svg/icons/icon-money.svg" alt="">
						</div>
						<div class="user-content">
							<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
								"AREA_FILE_SHOW" => "file",
								"PATH" => "/includes/podr/help_5.php"
							));?>
						</div>
					</div>
				</div>
			...
			<div class="grid-6 grid-5_l grid-12_m user-content">
				<img src="<?=SITE_TEMPLATE_PATH?>/img/disput-contract-about.jpg" alt="Носков Игорь юрьевич">
			</div>
			...
			<div class="row">
				<div class="grid-12">
					<div class="user-content">
						<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
							"AREA_FILE_SHOW" => "file",
							"PATH" => "/includes/podr/disput_text.php"
						));?>
					</div>
				</div>
			</div>
			...
			<div class="grid-6 grid-7_l grid-12_m disput-order__info">
				<div class="user-content">
					<div class="h1">
						<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
							"AREA_FILE_SHOW" => "file",
							"PATH" => "/includes/podr/por_title.php"
						));?>
					</div>
					<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
						"AREA_FILE_SHOW" => "file",
						"PATH" => "/includes/podr/por_text.php"
					));?>
				</div>
